...
const RAW = [
  ...
  [6,  'Abukir',                    '51.18.830', '2.18.493', 'passager', null, null,  false, null],
  [7,   'Admiralengracht',          '51.22.394', '03.11.941','cargo',    null, null,  false, null],
  [8,  'Adroit',                    '51.03.421', '2.23.192',  'dd',       1940, 18,    true,  'Contre-torpilleur français, Opération Dynamo'],
  ...
  [21,  'Basilisk',                  '51.08.281', '2.35.035',  'dd',       1940, 20,    true,  'HMS Basilisk, destroyer britannique, coulé 1er juin 1940'],
  [22,  'Bateau-feu',                '51.06.549', '2.14.207',  'autre',    1940, 28,    false, 'Bateau-feu (lightship) — voir aussi Bateau-feu Dyck'],
  ...
  [26,  'Bourrasque',                '51.14.936', '2.33.034', 'dd',       1940, 25,    true,  'Contre-torpilleur, 106m, 1458T, coulé 30 mai 1940 — ~500 victimes. Identifié 1984 (tête de sanglier).'],
  ...
  [31,  'Brighton',                  '51.03.088', '2.10.591', 'passager', 1940, null,  true,  'Paquebot britannique, Opération Dynamo'],
  [32,  'Brighton Belle',            '51.17.546', '1.29.986',  'passager', 1940, null,  true,  'Paddle steamer, Opération Dynamo'],
  [33,  'Brighton Queen',            '51.06.508', '2.11.315',  'passager', 1940, null,  true,  'Paddle steamer, Opération Dynamo'],
  [34,  'Bruno Heinemann',           '51.16.152', '2.17.045', 'dd',       1942, null,  false, 'Destroyer de la Kriegsmarine (classe Diether von Roeder)'],
  ...
  [42,  'Clan MacAlister',           '51.05.203', '2.28.657','cargo',    1940, 14,    true,  'Cargo écossais de la Clan Line, Opération Dynamo'],
  ...
  [48,  'Crested Eagle',             '51.04.557', '2.29.461', 'passager', 1940, 2,     true,  'Paddle steamer, visible marée basse plage Zuydcoote. ~600 à bord, >200 victimes mitraillés.'],
  ...
  [53,  'Denis Papin',               '51.07.271', '2.08.702',  'cargo',    null, null,  false, null],
  [54,  'Devonia',                   '51.04.769', '2.30.166', 'passager', 1940, 2,     true,  'Paddle steamer / dragueur de mines, coulé volontairement 30 mai 1940. Visible marée basse.'],
  [55,  'Douaisien',                 '51.04.636', '2.27.221',  'cargo',    null, null,  false, null],
  ...
  [60,  'Emile Deschamps',           '51.24.334', '1.29.348',  'cargo',    null, null,  false, null],
  [62,  'Empire Faith',             '51.21.654', '02.50.442','cargo',    null, null,  false, null],
  [63,  'Empire Path',              '51.21.71',  '2.50.53',  'cargo',    null, null,  false, null],
  [64,  'Etendard (1907)',           '51.06.586', '2.29.430','dd',       null, null,  false, 'Torpilleur français classe Branlebas (1907)'],
  [65,  'Etendard',                  '51.06.586', '2.29.430', 'dd',       1940, null,  true,  'Contre-torpilleur / destroyer français, Opération Dynamo'],
  [66,  'Etincelle',                '51.3.283',  '2.17.333', 'autre',    null, null,  false, null],
  [67,  'Etoile du Nord',            '51.04.217', '2.25.121',  'passager', null, null,  false, 'Fiche : dkepaves.free.fr/html/etoile_du_nord.htm'],
  [68,  'Fenella',                   '51.03.532', '2.21.336',  'passager', 1940, 5,     true,  'Ferry Isle of Man Steam Packet Co., Opération Dynamo'],
  [69,  'Flakplatform',             '51.14.71',  '02.55.70', 'autre',    null, null,  false, 'Plate-forme de DCA (Flak)'],
  [70,  'Flandre',                   '51.09.658', '2.19.548', 'passager', null, null,  false, null],
  [71,  'Florentino',               '51.20.870', '03.12.990','cargo',    null, null,  false, null],
  [72,  'Floride',                   '51.03.738', '2.23.549',  'cargo',    1939, null,  false, 'Cargo ex-La Marseillaise. Fiche : dkepaves.free.fr/html/floride.htm'],
  [75,  'Foudroyant',                '51.05.021', '2.15.479',  'dd',       1940, 28,    true,  'Contre-torpilleur classe Forbin, 100m, 1500T, coulé 1er juin 1940 vers 10h30. Orientation 325/155°. Munitions et fuel visibles.'],
  ...
  [81,  'Gourko',                    '51.03.826', '2.20.320',  'cargo',    1940, null,  true,  'Opération Dynamo'],
  [82,  'Gracie Fields',             '51.12.599', '2.39.526', 'passager', 1940, null,  true,  'Paddle steamer, Opération Dynamo'],
  [83,  'Grafton',                   '51.24.439', '2.49.099', 'dd',       1940, 30,    true,  'HMS Grafton, destroyer britannique, torpillé 29 mai 1940'],
  [84,  'Grenade',                   '51.03.144', '2.21.328', 'dd',       1940, null,  true,  'Contre-torpilleur français, Opération Dynamo'],
  [85,  'Greta Dania',              '51.35.54',  '3.12.77',  'cargo',    null, null,  false, null],
  [86,  'Grive',                     '51.03.676', '2.18.505',  'dd',       null, null,  false, null],
  [87,  'Halo',                     '51.21.135', '2.22.930', 'cargo',    null, null,  false, null],
  [88,  'Harfry',                   '51.3.650',  '2.20.517', 'cargo',    null, null,  false, null],
  [89,  'Havant',                    '51.07.927', '2.16.019',  'dd',       1940, null,  true,  'HMS Havant, destroyer britannique, coulé 1er juin 1940'],
  ...
  [99,  'Jaguar',                    '51.03.428', '2.22.181',  'dd',       1940, null,  true,  'Contre-torpilleur français, Opération Dynamo. Fiche : dkepaves.free.fr.'],
  ...
  [103,  'Keith',                     '51.04.770', '2.26.856',  'dd',       1940, 18,    true,  'HMS Keith, destroyer britannique, coulé 1er juin 1940. Bon spot lieu jaune.'],
  ...
  [108,  'King Orry',                 '51.03.944', '2.20.622', 'passager', 1940, 10,    true,  'Ferry Isle of Man Steam Packet Co., Opération Dynamo'],
  ...
  [117,  'Lorina',                    '51.03.584', '2.25.421', 'passager', 1940, 2,     true,  'Paquebot visible marée basse côté Leffrinckoucke. 8 victimes. Opération Dynamo.'],
  ...
  [126,  'Marie',                     '51.08.959', '2.33.827', 'cargo',    null, null,  false, null],
  [127,  'Marthe',                    '51.09.138', '2.13.081', 'cargo',    null, null,  false, 'Quatre-mâts. Fiche : dkepaves.free.fr/html/marthe.htm'],
  ...
  [132,  'Montrose',                  '51.03.383', '2.06.950',  'passager', null, null,  false, null],
  [133,  'Moussaillon',               '51.07.311', '2.08.509',  'chalk',    null, null,  false, 'Chalutier répertorié Dunkerque Plongée'],
  ...
  [144,  'Normannia',                 '51.03.845', '2.14.435',  'passager', null, null,  false, null],
  ...
  [155,  'Paris',                     '51.11.004', '2.07.646','passager', 1940, null,  true,  'Paquebot français. Fiche : dkepaves.free.fr/html/paris.htm. Opération Dynamo.'],
  [156,  'Peppinella',                '51.24.311', '2.15.011', 'cargo',    null, null,  false, null],
  [157, 'Plumpton',                 '51.14.580', '02.55.650','cargo',    null, null,  false, null],
  [158,  'Polly Johnson',             '51.10.516', '2.43.033',  'cargo',    null, null,  false, null],
  [159, 'Port de Beyrouth',         '51.3.033',  '2.23.133', 'cargo',    null, null,  false, null],
  [160,  'Portrieux',                 '51.00.416', '2.03.385',  'cargo',    null, null,  false, null],
  ...
  [164,  'Queen of the Channel',      '51.18.517', '2.43.289', 'passager', 1940, null,  true,  'Paquebot, Opération Dynamo'],
  ...
  [174,  'Saint Abbs',                '51.04.903', '2.27.517',  'cargo',    1940, null,  true,  'Opération Dynamo'],
  ...
  [177,  'Saint Corentin',            '51.03.518', '2.10.484', 'chalk',    null, null,  false, null],
  [178,  'Saint Fagan',               '51.04.309', '2.24.483',  'lct',      1940, 22,    true,  'Navire de sauvetage armé (43.6m × 8.85m), mine le 1er juin 1940 à 3h50. Retrouvé 2016 au magnétomètre.'],
  ...
  [193,  'Scotia',                    '51.06.475', '2.11.096',  'passager', 1940, null,  true,  'Paquebot LMS Scotia, Opération Dynamo'],
  ...
  [201,  'Siroco',                    '51.18.940', '2.14.064', 'dd',       1940, null,  true,  'Contre-torpilleur français, Opération Dynamo. Fiche : dkepaves.free.fr.'],
  [202,  'Skipjack',                  '51.04.988', '2.28.434', 'dd',       1940, null,  true,  'HMS Skipjack, dragueur de mines britannique, Opération Dynamo'],
  ...
  [211,  'Sterre D. Zee',             '51.05.383', '2.28.216', 'cargo',    null, null,  false, null],
  ...
  [214,  'Treffry',                   '51.03.065', '2.22.616',  'cargo',    null, null,  false, null],
  [215, 'Tricolor',                 '51.21.980', '2.12.790', 'cargo',    null, null,  false, null],
  [216,  'Trifels',                   '51.13.804', '2.22.106','cargo',    null, null,  false, 'Répertorié Dunkerque Plongée. Fiche : dkepaves.free.fr.'],
  ...
  [222,  'UB 29',                     '51.09.393', '1.43.366', 'sub',      null, 28,    false, 'Sous-marin allemand (1ère GM)'],
  ...
  [225,  'Vénus',                     '51.07.412', '2.09.165',  'cargo',    null, null,  false, null],
  ...
  [229,  'Vonette',                   '51.04.693', '2.30.037', 'cargo',    1929, 2,     false, 'Trois-mâts goélette (Saint-Malo 1921), naufrage tempête 1929. Visible marée basse Zuydcoote.'],
  ...
  [239,  'Wolf',                      '51.07.466', '2.29.954', 'dd',       1941, null,  false, 'Torpilleur allemand coulé à Dunkerque 1941'],
